...
//Sirve para dibujar el cilindro y elc ono  esta función de CreateMeshGeometey
...
void Mesh::RenderMeshGeometry()
{
	...
	glBindVertexArray(VAO);
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, IBO);
	glDrawElements(GL_TRIANGLE_FAN, indexCount, GL_UNSIGNED_INT, 0);	//Esta TriangleFan dibuja que todos los triángulos tengan en común el mismo vértice de inicio. como abanicos o ventilador que tienen un centro en común
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0);
	glBindVertexArray(0);
}
