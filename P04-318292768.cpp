...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//LLANTA 1
		modelaux = model;
		model = glm::translate(model, glm::vec3(3.0f, 1.5f, -7.0f));
		...
		//LLANTA 3
		modelaux = model;
		model = glm::translate(model, glm::vec3(-3.0f, 1.5f, -0.9f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::scale(model, glm::vec3(5.5f, 4.0f, 5.5f));
		...
		//Meter aqui una rotación con el puro brazo
		...
		model = glm::translate(model, glm::vec3(5.0f, -4.0f, 2.5f));
		modelaux = model;
		...
		model = modelaux;
		//model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3() + 135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 5.0f, 1.0f));
		...
		//Estas 4 líneas de código nos permite el movimiento de los objetos
		model = modelaux;
...
/////////////////////////////////////
		...
		//Oreja 2
		modelaux = model;
		model = glm::translate(model, glm::vec3(3.0f, 0.5f, -6.7f));
		...
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		//meshList[1]->RenderMeshGeometry(); //dibuja cubo y pirámide triangular
		meshList[3]->RenderMeshGeometry();

		model = modelaux;
		//Oreja 1
		modelaux = model;
		model = glm::translate(model, glm::vec3(3.0f, 0.5f, -1.3f));
		model = glm::rotate(model, glm::radians(30.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion6()), glm::vec3(0.0f, 1.0f, 0.0f));
		model = glm::scale(model, glm::vec3(0.8f, 2.5f, 0.8f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//Para el cuello debemmos cambiar el numero de triángulos en la función cono
		//Cuello
		modelaux = model;
		model = glm::translate(model, glm::vec3(-3.0f, 0.5f, -7.0f));
		model = glm::translate(model, glm::vec3(7.0f, -7.5f, 3.0f));
		model = glm::rotate(model, glm::radians(15.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::scale(model, glm::vec3(1.5f, 5.0f, 1.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.0f, 0.0f, 0.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color)); //para cambiar el color del objetos
		meshList[2]->RenderMeshGeometry(); //dibuja cubo y pirámide triangular
		...
		//CUERPO esfera
		model = glm::translate(model, glm::vec3(0.0f, 5.5f, -4.0f));
		model = glm::translate(model, glm::vec3(9.0f, -17.0f, -.5f));
		modelaux = model;
		...
		//CUERPO pirsma rect
		model = glm::translate(model, glm::vec3(0.0f, 5.5f, -4.0f));
		model = glm::translate(model, glm::vec3(7.0f, -4.5f, 4.0f));
		modelaux = model;
		...
		//articulación 1
		model = glm::translate(model, glm::vec3(2.5f, 0.5f, 3.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		...
		model = glm::mat4(1.0);
		//articulación 2
		model = glm::translate(model, glm::vec3(18.5f, -10.0f, -7.5f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion7()), glm::vec3(0.0f, 0.0f, 1.0f));
		modelaux = model;
		//dibujar una pequeña esfera
		model = glm::scale(model, glm::vec3(1.0f, 1.0f, 1.0f));
		...
		model = modelaux;
		//model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion8() + 135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 4.0f, 1.0f));
		...
		model = glm::mat4(1.0);
		//articulación 2
		model = glm::translate(model, glm::vec3(4.0f, -10.0f, -7.5f));
		...
		model = modelaux;
		//model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion10() + 135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 4.0f, 1.0f));
		...
		model = glm::mat4(1.0);
		//articulación 2
		model = glm::translate(model, glm::vec3(4.0f, -10.0f, -1.5f));
		...
		model = modelaux;
		//model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion12() + 135.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(1.0f, 4.0f, 1.0f));
		...
		////////////////////////////////////
		//P, O	MANEJAN		ENFRENTE DERECHA
		//K, L	MANEJAN		OREJAS
		//E, R 	MANEJAN		ATARS DERECHA
		//U, I 	MANEJAN		ENFRENTE IZQUIERDA}
		//G, H 	MANEJAN		ATRAS IZQUIERDA
